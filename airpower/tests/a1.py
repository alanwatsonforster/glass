...
checkaircraft(A1, "1115       N    10", 4.0)
checkaircraft(A2, "1315       NNE  20", 4.5)
checkaircraft(A3, "1515       ENE  30", 5.0)
checkaircraft(A4, "1715       NNW  40", 5.5)
checkaircraft(A5, "1915       WNW  50", 6.0)
