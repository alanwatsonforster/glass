...
The document describes the properties of ground units and ground targets in the \emph{Air Power} game system, focusing on those relevant for the period from 1950 to 2000\footnote{Over what period are the rules relevant? I don't think they've adequate for current air combat, since it depends so heavily on stealth. They are probably not too bad up to 2000. I could be persuaded to continue to 2010. Relevant in-service dates are: F-117 in 1983, B-2 in 1997, F-22 in 2005, and F-35 in 2015.}.
...
A ground \emph{unit} is a combat formation of infantry, armor, transports, AAA, SAM launchers, and radars. This section discusses them in general.\footnote{Some of this stuff should go into the 3A rules, but it's here for the moment.}
...
A ground unit has a numerical damage resilience, which is the amount of damage it can suffer before being killed\footnote{Air Strike has a form of this, units whose counters have white text being only able to take 1D of damage before being killed (see the last paragraph of rule 28). These include infantry SAMs, armored CCUs, and many vehicle SAMs. TSOH also mentioned this, but it doesn't have any relevant units. I'm generalizing and homogenizing this. I need sections for AAA units with two gun mounts, such as the Gepard, and for the Oerlikon GDF as Skyguard can only control two guns and not a full battery. To a large degree, a section is equivalent to a platoon that has taken 1D and a squad is equivalent to a platoon that has taken 2D.}. It is determined by the size of the unit:
\begin{itemize}
...
\begin{itemize}
    ...
    \item A hard target has armored protection both from side and top attacks and is denoted by an underlined defense strength. It is classified as heavy, medium, or light according to its degree of protection, but this classification is simply descriptive. Most tanks, IFVs, and APCs are hard targets.\footnote{Most tracked SAM vehicles are classified as hard targets, despite many of them having completely exposed missiles. If you hit a SA-4 launcher with an air-burst, do you think it is going to shrug it off? I think many tracked SAM vehicles are tracked mainly for mobility and perhaps for crew protection, but in terms of a mission-kill they are soft targets. I've not changed anything yet --- they are still hard --- but we need to think about this.}

    \item An open target has armored protection from side attacks but not from top attacks and is denoted by an underlined defense strength followed by an exclamation point. It is normally treated as a hard target, but against napalm, fire, FAE, and air-burst HE bombs, it is considered to be a soft target. The BTR-50P APC and the M3 half-tracked APC are examples of open targets.\footnote{Yes, so open targets are relevant to the 1956 and 1967 Arab-Israeli Wars. Again, if you hit an M3 with an air-burst or napalm, the crew are not going to be happy.}

    \item A soft target does not have armored protection and does not have an underlined defense strength. Examples include infantry, towed artillery, unarmored vehicles, and armored vehicles that do not fully protect their personnel and weapons such as the M-107 and M-110 tracked artillery vehicles.\footnote{Nothing like the M-110 is included in Air Strike, but again I would assert that the tracks are mainly for mobility and only the driver is protected. Effectively, these are towed artillery pieces plonked down on a tracked hull with almost no protection for the crews.}
...
A ground unit may occupy hexes as follows:\footnote{The basic rule is effectively: don't put trucks or towed weapons in forests unless there is a road.}
\begin{itemize}
...
The following restrictions supersede those in the basic rules:\footnote{The advanced rule is effectively: and maybe you have to keep your trucks and towed vehicles near roads even in clear terrain. The inspiration for this rule was \href{https://commons.wikimedia.org/wiki/File:Aerial_view_of_the_road_through_Mitla_Pass_dotted_with_wrecked_Egyptian_vehicles_and_armour_after_Israel_air_force_attacks._June_1967._D326-013.jpg}{this image} of the Mitla Pass from 1967. Also, think of the Falklands; the terrain was open, but impassable to everything except the CVR(T)s and Bv~202s.}
\begin{itemize}
    \item A unit with unrestricted mobility may occupy: any urban hex; any clear hex; or any forest hex.
...
An infantry and towed unit may be \emph{transported} by a specific IFV, APC, truck, or tracked-carrier \emph{transport} unit.\footnote{The idea of transporting units comes from the “Thunder and Fire” scenario we're currently playing.}
...
At the start of a game, a dismounted unit may be placed according to either its mobility or that of its transport.\footnote{Thus a tracked transport can place a towed unit in a forest hex.}
...
A dismounted infantry unit in the same hex as its transport may begin to mount by declaring its intention at the start of a Ground Unit Interaction Phase.\footnote{The rules for mounting and dismounting are completely new and made up. I'm very open to suggestions about this.}
...
The \emph{attached} units are commonly infantry SAM or FAC units. A scenario may add further restrictions on forming composite platoons.\footnote{This rule comes from TSOH. It doesn't have counters for infantry SAMs, so in the Easter Offensive scenarios it says treat infantry platoons as if they have an infantry SAM squad. This rule helps with stacking (since attached squads and sections do not count) and with keeping your precious FACs and SAM teams anonymous. It also works nicely with the transport rule, since attached squads and sections do not need their own transport but can hop a ride with the platoon.}
...
VPs are awarded for damage to any of the constituent units.\footnote{The roll of \minusafter{4} seems about right. The probability of killing an attached squad is 40\% for 1D and 64\% for 2D. Those numbers are fairly good approximations to 1/3 and 2/3. If the roll was \minusafter{3}, they would be 30\% and 51\%, and that seems a little low.}
...
Infantry are soldiers trained to fight on foot. An infantry, infantry weapons, or infantry HQ platoon consists of thirty to fifty soldiers. An infantry weapons platoon will be equipped with machine guns, ATGMs, grenade launchers, or mortars.\footnote{An infantry weapons platoon is not strictly necessary, but it adds to the look-and-feel, and we might consider giving them longer range in ground-to-ground combat. Having a single type is probably more appropriate than having separate types for mortar, grenade launchers, recoilless rifles, ATGMs, and machine guns. That said, the .50 cal infantry AAA unit could serve as a machine-gun platoon.} A mechanized infantry platoon will be associated with a platoon of APCs or IFVs. A motorized infantry platoon will be associated with a platoon of trucks.
...
An infantry FAC or SAM section has two squads.\footnote{I am sorely tempted to eliminate SAM and FAC sections and just leave squads. SAM squads in Air Strike can take 1D damage and have one launcher, and that makes sense to me. However, FAC units in Air Strike are labelled as a section but can take 2D damage. That makes no sense to me. The rules say a FAC unit has six to eight men, and that sounds like a squad to me.}
...
Tanks are distinguished as having heavy, medium, or light armor. An anti-tank vehicle is a lightly armored vehicle equipped with ATGMs.\footnote{Again, anti-tank units are mainly chrome. However, in ground combat we might give them more effectiveness against vehicular or towed targets and less against infantry targets.}
All tank and anti-tank units are platoons.
Examples include:\footnote{Based on the WRG 1950-1985 rules. Open is class I. Soft is class II to III. Hard is class IX and X. More modern tanks are guesses, and I'm willing to be corrected.}
...
However, an IFV provides fire support and typically has a 20 mm or larger cannon, and an APC does not.\footnote{And again we might distinguish APCs and IFVs in ground-to-ground combat. Bradley's made mincemeat of Iraqi tank regiments; M113s would not have had the same impact.}
...
\begin{itemize}\raggedright
    ...
    \item Heavy APCs: converted heavy tanks.\footnote{Heavy and medium APCs are not really relevant, but they exist and are easy to include once you've added medium IFVs.}
...
\begin{itemize}\raggedright
    ...
    \item Armored Artillery: 2S3 Akatsiya, 2S19 Msta-S, Abbot, AMX-30 AuF1, AS-90, M109, and Panzerhaubitze 2000.\footnote{I probably will include self-propelled mortars as armored artillery too. That said, it would only take me five minutes to make the counter with a mortar symbol and add them to the tables.}
    ...
    \item Mobile Missile Artillery: 9K52 Luna-M (Frog), OTR-21 Tochka (SS-21), and RSD-10 Pioneer (SS-20).\footnote{Missile artillery is mainly included to serve as a target.}
...
An armored or infantry HQ platoon represents the HQ unit of a battalion or regiment.\footnote{I wondered if HQ platoons were also used at the company level, but looking at the Air Strike scenarios they are included at a ratio of about one HQ platoons to nine normal platoons, so they seem to be batallion HQs.} There are no IFV, APC, or truck HQ units; the HQ platoon of a mechanized or motorized infantry battalion or regiment will consist of either an armored HQ platoon or an infantry HQ platoon associated with a normal IFV, APC, or truck platoon.
...
They are available as sections (with two launchers) and squads (with one launcher).
Unless otherwise specified, each launcher has one ready missile and two reloads available.

Infantry SAM units may be attached to infantry, infantry weapons, or infantry HQ platoons.
