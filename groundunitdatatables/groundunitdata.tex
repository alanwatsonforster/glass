...
All ground units have these common properties which together determine their visibility to aircraft, their vulnerability to air-to-ground and ground-to-ground attacks, their capacity for ground-to-ground capacity, their ability to move through difficult terrain, and value in VPs:
\begin{itemize}
...
Ground units can be squads, sections, platoons, or batteries according to their number of soldiers, vehicles, guns, or launchers. Typically:
...
Companies, battalions, and other larger units exist above platoons or batteries, but they are represented by multiple units. For example, an infantry company might be formed by one infantry HQ platoon and two infantry platoons.

\subsection{Damage Resilience}

Ground units have a numerical damage resilience, which is the amount of damage they can suffer before being killed. It is determined by the size of the unit:
\begin{itemize}
...
Ground units have a numerical damage strength and target class, which are used to calculate the odds of an air-to-ground attack and in ground-to-ground combat.

Ground unit can be hard, open, or soft targets according to the degree to which they provide armored protection to their personnel and weapons:
...
\begin{itemize}
    ...
    \item Open targets have protection from side attacks but not from top attacks and are denoted by underlined defense strengths followed by an exclamation point. They are normally treated as hard targets, but against napalm, fire, FAE, and air-burst HE bombs they are considered to be soft targets. The BTR-50P APC and the M3 half-tracked APC are examples of open targets.
...
Ground units have a mobility that can place limits on where they may be placed at the start of a game and move on the map. Ground units can have unrestricted (U), good (G), or poor (P) mobility:
\begin{itemize}
    \item Infantry units, except infantry heavy weapons units, have unrestricted mobility;
    \item AFV units, both tracked and wheeled, and tracked carrier units have good mobility; and
    \item Truck units, towed weapons units, and infantry heavy weapons units have poor mobility.
\end{itemize}

Ground units may occupy hexes according to their mobility and the following rules:
\begin{itemize}
    \item No unit may occupy a water hex.
    \item Any unit may occupy an urban hex.
    \item A unit with unrestricted mobility may occupy:
        \begin{itemize}
            \item any clear hex
            \item any forest hex.
        \end{itemize}
    \item A unit with good mobility may occupy:
        \begin{itemize}
            \item any clear hex
            \item a forest hex only if it has a road or trail, is adjacent to another forest hex with a road or trail, is adjacent to a clear hex, or is adjacent to an urban hex.
        \end{itemize}
    \item A unit with poor mobility may occupy:
        \begin{itemize}
            \item a clear hex only if it has a road, trail, or runway, is adjacent to another clear hex with a road, trail, or runway, or is adjacent to an urban hex.
            \item a forest hex only if it has a road, trail, or runway.
        \end{itemize}
\end{itemize}

These rules, for example, limit AFVs to the edges of forests and trucks to being on or close to roads, trails, runways, and urban areas.

Figure~\ref{figure:mobility} illustrates these rules: units with poor mobility may only occupy the hexes marked with green dots; those with good mobility may only occupy those marked with yellow or green dots; and those with unlimited mobility may only occupy the hexes marked with red, yellow, or green dots.

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{figure-mobility.png}
    \caption{Mobility. {\normalfont Ground units with poor mobility may only occupy the hexes marked with green dots; those with good mobility may occupy those marked with yellow or green dots; and those with unlimited mobility may occupy the hexes marked with red, yellow, or green dots.}}
    \label{figure:mobility}
\end{figure}

A scenario may remove some of these restrictions or add others. For example, a scenario with airmobile forces might allow a towed artillery battery to have been transported by helicopter to any clear hex and one set in the open desert of southern Iraq might allow a truck platoon freedom to occupy any clear hex.
...
The representation mainly uses NATO symbols, including those for infantry, armor, air defense, guns, missiles, tube artillery, and rocket artillery. One addition is that a rectangle denotes an unarmored vehicle such as a truck or tracked carrier. All vehicular units have either an armor or unarmored vehicle symbol, all infantry units have an infantry symbol, and towed units have none of these.
...
The size is indicated by one, two, or three dots (for squads, sections, or platoons) or one vertical bar (for batteries) in an upper position.
...
Tanks are armored vehicles that are specialized in direct fire. Tanks are distinguished as having heavy, medium, or light armor. Anti-tank vehicles are lightly armored vehicles equipped with ATGMs. All tank and anti-tank units are platoons.  Examples include:

\begin{itemize}\raggedright
    \item Heavy Tanks:Chieftain, Challenger 1/2, Conqueror, IS-3, Leclerc, Leopard 2, M1 Abrams, Merkava
        T-10, T-64, T-72, T-80, T-84, and T-90.
    \item Medium Tanks: AMX-30, Centurion, Kanonenjagdpanzer, Leopard 1, M4 Sherman, M26 Pershing, M46/47/48 Patton, M103,  M60, T-34, IS-2, T-54/55, and T-62.
    \item Light Tanks: AMX-10 RC, AMX-13, Ferret, Fox, M24 Chaffee, M41 Walker Bulldog, M551 Sheridan,  Panhard AML, Panhard EBR, PT-76, Scimitar, and Scorpion.
    \item Light Anti-Tank Vehicles: AMX-10P HOT, BRDM-2/3 variants, FV438 Swingfire, Jaguar 1/2, M150, M901 ITV, M1134 ATGM, Raketenjagdpanzer 1/2, Striker, and VAB HOT.
\end{itemize}
...
An infantry FAC squad has a forward air controller with other soldiers for transport and communication. It will often be associated with a truck squad. An infantry FAC section has two squads. Infantry FAC units may be attached in infantry or infantry HQ platoons.
...
Armored cars and armored half-tracks are considered to be light tanks, light ant-tank vehicles, light IFVs, or light APCs according to their role and armament.
...
\subsection{Transported Units and Transports}

An infantry and towed unit may be associated with a specific IFV, APC, truck, or tracked carrier unit.
The former unit is the \emph{transported} unit and the latter is its \emph{transport}.
...
A dismounted unit and its transport need not occupy in the same hex.

\paragraph{Mounted Units.}

A mounted unit is not represented by a separate counter, does not count for stacking, and may not be attacked directly, but instead is considered to form part of its transport unit.
...
The transported unit may abort the process at end of the Ground Unit Interaction Phase.

\paragraph{Mounting and Dismounting Towed Units.}

A towed unit may not mount or dismount during the game.

\subsection{Composite Units}

At the start of a game, an infantry platoon or infantry HQ platoon may \emph{attach} one or two infantry squads or one infantry section to form a \emph{composite platoon}. The attached units are commonly infantry SAM or FAC units. Once formed, a composite platoon may not be split into its constituent units.

A composite platoon is considered to have the mobility of the least mobile of its constituent units. Its defense strength is unchanged.

An attached unit is not represented by a separate counter, does not count for stacking, and may not be attacked directly, but instead is considered to form part of the composite platoon.
...
A scenario may add further restrictions on composite platoons.
...
Infantry SAM units may be attached in infantry or infantry HQ platoons.
...
In Strela-2M was often used with the PRP portable IFF interrogator.
...
The FIM-92A entered service with the US Army in 1981, the FIM-92B in 1986, the FIM-91C in 1989, and the FIM-92D in 1992. They were exported to dozens of US allies including the Afghan Mujahedeen and the Angolan UNITA. They saw service in the 1982 South Atlantic War, the Soviet-Afghan War, the Angolan Civil War, the Libyan Invasion of Char, the Tajik Civil War, the Chechen War, the Sri Lankan Civil War, the Syrian Civil War, and the Russian Invasion of Ukraine.
...
Starstreak is high-speed laser-guided missile. As the missile approaches the target, it launches three independent explosive darts. The darts have contact fuzes, but not proximity fuzes.
...
The Starstreak Light Multiple Launcher (LML) has three ready-to-fire Starstreak missiles on a pedestal mount with a single sighting unit. It is an infantry heavy weapon and squads and sections equipped with it have poor mobility.
...
The Mistral is a French IR-homing missile on a pedestal mount. The missile has a considerably larger warhead than either the Stinger or Igla missiles, but this comes at a cost in portability. Mistral is an infantry heavy weapon and squads and sections equipped with it have poor mobility.

The Mistral entered service with the French Army in 1990. It was subsequently exported in many other countries.

\subsubsection{RBS 70 Squad or Section}

The RBS 70 is a Swedish laser-guided missile on a pedestal mount. It is an infantry heavy weapon and squads and sections equipped with it have poor mobility.

The RBS 70 entered service with the Swedish Army in 1977. It was subsequently used by Argentina, Australia, Bahrain, Brazil, the Czech Republic, Iran, Ireland, Lithuania, Norway, Pakistan, Singapore, Thailand, Tunisia, UAE, Ukraine, and Venezuela.
...
All ground targets have these properties: a defense strength; a classification as a hard or soft target; a sighting range in hexes; and the VPs awarded for 3D/2D/D damage. These properties are shown in Table~\ref{table:ground-targets}.
