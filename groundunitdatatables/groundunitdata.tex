...
Ground units have a mobility that can place limits on where they may normally be placed or move on the map. Ground units can have unrestricted (U), good (G), or poor (P) mobility:
\begin{itemize}
...
Ground units may normally be placed and move according to the following rules:
\begin{itemize}
