...
A ground \emph{unit} is a combat formation of infantry, armor, transports, AAA, SAM launchers, and radars.
...
A ground unit has a mobility that can place limits on where it may be placed at the start of a game and move on the map. A ground unit can have unrestricted (U), good (G), or poor (P) mobility:
\begin{itemize}
    \item An infantry unit, except an infantry heavy weapons unit, has unrestricted mobility;
    \item An AFV unit, both tracked and wheeled, or a tracked carrier unit has good mobility; and
    \item A truck unit, a towed unit, or an infantry heavy weapons unit has poor mobility.
\end{itemize}

A ground unit may occupy hexes according to its mobility and the following rules:
\begin{itemize}
...
These rules, for example, limit an AFV unit to the edges of forests and a truck unit to being on or close to roads, trails, runways, and urban areas.

Figure~\ref{figure:mobility} illustrates these rules: a unit with poor mobility may only occupy the hexes marked with green dots; one with good mobility may only occupy those marked with yellow or green dots; and one with unlimited mobility may only occupy the hexes marked with red, yellow, or green dots.

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{figure-mobility.png}
    \caption{Mobility. {\normalfont A ground unit with poor mobility may only occupy the hexes marked with green dots; one with good mobility may occupy those marked with yellow or green dots; and one with unlimited mobility may occupy the hexes marked with red, yellow, or green dots.}}
...
The letter T in the central position indicates a transport capacity (e.g., APCs, IFVs, cargo trucks, and tracked cargo carriers). For an armored vehicle unit, one of the letters H, M, L, and O in the lower position indicate heavy, medium, light, and open armored protection. For an infantry unit, a letter H in the lower position indicates a heavy weapons unit.

An armored unit implicitly has good mobility. A truck unit has poor mobility if it has a two-wheeled symbol in the lower position and good mobility if it has a three-wheeled, half-tracked, or tracked symbol in the lower position. An infantry unit implicitly has unrestricted mobility, unless it has a letter H in the lower position, in which case it is a heavy weapons unit with poor mobility.
...
A ground-combat unit represents infantry, tanks or other AFVs, trucks, tracked carriers, or artillery. Its primary role is combat with other ground units.
...
\begin{itemize}\raggedright
    ...
    \item Medium Tanks: AMX-30, ASU-85, Centurion, Kanonenjagdpanzer, Leopard 1, M4 Sherman, M26 Pershing, M46/47/48 Patton, M103,  M60, Panzer 61, Panzer 68, SU-100, T-34, IS-2, ISU-122, ISU-152, T-54/55, T-62, and TAM, Type 59/69/79, Type 61, Type 74, Type 80/88/96, Vickers MBT, and Vijayanta.
...
\begin{itemize}\raggedright
    ...
    \item Light APCs: BTR-50PK, BTR-60/70/80, FV432, M113, M114, Saracen, Spartan, most Stryker variants, and VAB.
...
Trucks and tracked carriers are unarmored or incompletely armored vehicles that transport infantry, towed weapons, and supplies. The difference is that a truck has poor mobility whereas a tracker carrier (e.g., an M548) has good mobility. Trucks include light trucks such as Jeeps, Land Rovers, and Humvees.
...
A truck platoon may serve as the transport of a towed artillery battery.

\subsection{HQ Units}

A tank or infantry HQ platoon represents the HQ unit of a company or battalion. There are no IFV, APC, or truck HQ units; the HQs platoon of a mechanized or motorized infantry unit will consist of an infantry HQ platoon associated with a normal IFV, APC, or truck platoon.
