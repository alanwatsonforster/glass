...
\subsubsection{Embedded Infantry Squads}
...
\begin{itemize}\raggedright
    ...
    \item Anti-Tank Vehicles: AMX-10P HOT, BRDM-2/3 variants, FV438 Swingfire, Jaguar 1/2, M150, M901 ITV, M1134 ATGM, Raketenjagdpanzer 1/2, Striker, and VAB HOT.
\end{itemize}
...
An infantry FAC squad has a forward air controller with other soldiers for transport and communication. It will often be associated with a truck squad. An infantry FAC section has two squads. Infantry FAC squads (but not sections) may be embedded in infantry or infantry HQ platoons.
