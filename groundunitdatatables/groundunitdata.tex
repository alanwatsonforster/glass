...
\footnote{
    For the Sinai 23: The turret seems to be similar to the LAV-AD turret, so I've adopted the same hit rolls. The range and damage rolls are adopted from the mobile ZU-23 section. I don't know which model of Stinger was used; I would guess the FIM-92A.
}
...
\footnote{
    For the ZSU-23-4: The values are adopted from Air Strike.
}
...
\footnote{
    For the LAV-AD: The system seems similar to the Blazer, but without radar and with night IR sights. I've adopted the range and damage rating for the Blazer, and the hit rolls of 4/3/2 which corresponds to those of the M163 with a \minus{1} modifier for not having FCR-R.
}
...
\footnote{
    The hit rolls of 4/3/2 in Air Strike seem a little high. A modern 23/30/35 mm section with FCR typically has 5/4/3. I adopt 3/2/1, matching the mobile ZU-23 and the AMX-30 and Tunguska without FCR. If the VADS is classed as armored, should this be armored too?
}
