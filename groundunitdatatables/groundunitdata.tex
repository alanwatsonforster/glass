...
\begin{itemize}
    ...
    \item Tracked AFVs, wheeled AFVs, and tracked carriers have good mobility; and
...
The Starstreak Light Multiple Launcher (LML) has three ready-to-fire Starstreak missiles on a pedestal mount with a single sighting unit.
...
The Mistral is a French IR-homing missile on a pedestal mount. It has a considerably larger warhead than either the Stinger or Igla missiles, but this comes at a cost in portability.
...
The RBS 70 is a Swedish laser-guided missile on a pedestal mount.
