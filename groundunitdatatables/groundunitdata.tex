...
\note{
    ...
    \begin{tabular}{lrlllllrrl}
        ...
        ZPU-1&6&2/3/5&3/2/1&1&---&14.5&600&1000&EOTG\\
        ...
        ZU-23&&&5/4/3 &&\multicolumn{5}{l}{--- for rate of fire}\\
    ...
    This is as expected.
    Quantitatively, approximately doubling the rate of fire seems to increase the hit rolls by one.

    Most of the original values can be used as they are, but a few of the hit rolls need adjusting:
    \begin{itemize}
        \item The single Rh-202 has unexpectedly low original hit rolls of 3/2/1 for its rate of fire. The values of 4/3/2 for the ZPU-2 and TCM-20, which have a similar rate of fire, are probably more appropriate.
        \item The ZU-23 has unexpectedly low original hit rolls of 4/3/2 for its rate of fire. The values of 5/4/3 for the twin Rh-202, which has a similar rate of fire, are probably more appropriate.
        \item The Oerlikon GDF has unexpectedly high original hit rolls of 5/4/3 for its rate of fire. The values of 4/3/2 for the ZPU-2, which has a similar rate of fire, are probably more appropriate. (This reduction also makes the Oerlikon GDF more consistent with Gepard.)
        \item The BOFI has unexpectedly low original hit rolls of 4/4/3. Values of 5/5/3, obtained by applying a \plus{2} modifier for FCR-W to the Bofors L/70, are probably more appropriate. (Note that the “BOFI” in \emph{Air Strike} corresponds to what I call the “BOFI-R” below.)
    \end{itemize}
    ...
    \begin{itemize}
        \item The M167 and Gemag have hit rolls of 6/5/4, and the twin Rh-202 has 5/4/3. Otherwise, they are similar, except that the M167 and Gemag have FCR-R, and the Rh-202 does not (and the M167 has a moderate advantage in rate of fire). I consider the FCR-R of the M167 and Gemag to be largely responsible for increasing their hit rolls by \plus{1} compared to the Rh-202.
        \item The hit rolls of 2/2/1 for the Bofors L/60, 3/2/1 for the 61-K (M-38), and 3/3/2 for the Bofors L/70 seem to reflect the increase in rate of fire. However, the L/60 has the same maximum altitude and ranges as the L/70, despite its lower muzzle velocity.
        \item The real BOFI and BOFI-R also use proximity fuzes, and I consider these will increase their hit rolls by \plus{1}.
    \end{itemize}
    ...
    \begin{tabular}{lrlllllrrl}
        ...
        Mobile ZU-23&9&2/5/8&3/3/2&2&---&23&2000&980&AS\\
        Nile 23&9&2/5/8&3/3/2&2&---&23&2000&980&EOTG\\
        ZSU-23-4&9&2/5/8&5/4/3&2&W&23&4000&980&AS\\
        ...
        \multicolumn{10}{c}{Modified}\\
        \midrule
        Mobile ZPU-4&&&4/3/2&&\multicolumn{5}{l}{--- to match to ZPU-4}\\
        Panhard&&&3/3/2&&\multicolumn{5}{l}{--- to match M3 TCM-20}\\
        Mobile ZU-23&&&4/3/2&&\multicolumn{5}{l}{--- to match ZU-23}\\
        Nile 23&&&4/3/2&&\multicolumn{5}{l}{--- to match ZU-23}\\
        M53/59&&&3/2/1&&\multicolumn{5}{l}{--- to match GDF/AMX-30}\\
        ZSU-30-2&&&&3&\multicolumn{5}{l}{--- to match other 30 mm}\\
        \bottomrule
    \end{tabular}
    \medskip

    Comparing similar weapons, batteries (with four to six mounts) typically have a \plus{1} advantage on their hit rolls compared to sections (with two mounts).
    ...
    The method for the values I will adopt for AAA units is:
    \begin{itemize}
    ...
    \begin{itemize}
        \item The original hit rolls and the predicted hit rolls are in agreement for the M16 (from the M55 battery), M3 TCM-20 (from the TCM-20 battery), M163 (from the M167 battery),
        \item The original hit rolls for the mobile ZPU-4 section are 3/3/2, but 4/3/2 is predicted from the values of 5/4/3 for the battery and is in better agreement with the values for the M16.
        \item The Panhard M3 DCA has unexpectedly low original hit rolls of 2/2/1 compared to the TCM 20 battery and the M3 TCM-20 section. Values of 3/3/2 are probably more appropriate.
        \item The original hit rolls for the mobile ZU-23 and Nile 23 section are 3/3/2. The predicted values of 4/3/2 are probably more appropriate and is in better agreement with the values for the M16.
        \item The original hit rolls for the M53/59 section are 4/3/2. The predicted values of 3/2/1, derived from the modified hit rolls of 4/3/2 for the Oerlikon GDF battery and also from the AMX-30SA after discounting the FCR-W, are probably more appropriate.
        \item The ZSU-30-2 has an unexpectedly high original damage rating of 4. The value of 3 for the other 30 mm guns is probably more appropriate.
        \item The ZSU-57-2 section has the same hit rolls as the S-60 battery. This is probably appropriate, as the ZSU-57-2 is a twin mount and this largely compensates for the reduced rate of fire of the section. The same applies to the quad ZSU-23-4 compared to the twin ZU-23.
    \end{itemize}
    ...
    \begin{itemize}
        \item The Panhard M3 DCA has an FCR-R capability, which is discussed below but not considered here.
        \item The real AMX-30DCA does not have a FCR. The AMX-30DCA in the game seems to correspond to the similar AMX-30SA, which does.
    \end{itemize}
...
\note{
    For the ZPU-1 battery: The AAA values are from \emph{Eagles of the Gulf}.
}%
\note{
    For the ZPU-2 battery: The AAA values are from \emph{Air Strike}.
}%
\note{
    For the ZPU-4 battery: The AAA values are from \emph{Air Strike}.
}
...
\note{
    ...
    AAA values are from \emph{Air Strike}, except that I have adopted hit rolls of 4/3/2 rather than 3/3/2 using the method described above.
...
\note{
    For the mobile ZPU-1 and ZPU-2 section: These do not appear in any of the \emph{Air Power} sources, but they are very common. Following the mothod described above, I have chosen to apply the \minus{1} battery-to-section modifier to AAA values of ZPU-1 and ZPU-2 batteries.
}
...
The Rheinmetall Rh-202 has a single or twin 20 mm gun in an open mount on a towed carriage. The fire-control system is entirely optical. The most common version is the twin mount. A battery has six gun mounts.%
\note{
    For the single and twin Rh-202 batteries: All AAA mounts seem to be twin. The AAA values are from \emph{Air Strike}, with the hit rolls of the single version modified from 3/2/1 to 4/3/2 as described above.
}
...
\note{
    ...
    \emph{Air Strike} gives hit rolls of 3/3/2, which are identical to those of the M3 TCM-20 section. Since they have similar guns, that would make sense if both had similar fire control systems. However, the Panhard M3 DCA radar-equipped vehicle seems to be able to search and share speed and range information with the other vehicle in the section. That seems closest to FCR-R. Therefore, following the method described above, I have adopted the \emph{Air Strike} values but with hit rolls increase by one to 4/4/3 and FCR-R.
}
...
\note{
    For the ZU-23 battery: The AAA values are from \emph{Air Strike}, but the hit rolls are modified as from 4/3/2 to 5/3/2 as described above.
...
\note{
    For the mobile ZU-23 section:  The AAA values are obtained by applying a \minus{1} modifier to the ZU-23 battery, giving hit rolls of 3/2/1, which seems more appropriate. \emph{Air Strike} gives hit rolls of 2/2/1.
    %The VPs seem about right, as the battery has 6 VPs. Air Strike gives and 5 VPs.
}
...
\note{
    For the Sinai 23 section: The turret seems to be similar to the LAV-AD turret, but with a pair of 23 mm guns instead of a GAU-12 25 mm gun. The AAA values rolls are adopted from the mobile ZU-23 section. I don't know which model of Stinger was used; I would guess the FIM-92A.
}
...
\note{
    For the Gepard section: The AAA values are from \emph{Air Strike}. The hit rolls of 5/4/3 agree with those of an Oerlikon GDF battery, modified as described above and then reduced by one to convert from battery to section and increased by two to account for FCR-W.
}
...
\note{
    For the 61-K battery: \emph{Air Strike}, \emph{Eagles of the Gulf}, and \emph{The Speed of Heat} call this the “M-38”, but I can find no other source that uses this designation. Another designation for the gun is “M-1939”, so I could understand “M-39“. The AAA values are from \emph{Air Strike}.
...
\note{
    For the Bofors L/70 battery: The AAA values are from \emph{Air Strike}, with the maximum altitude increase from 15 to 16, as described above.
}
...
\note{
    RECONSIDER THIS:
    For the BOFI and BOFI-R battery: I've not been able to find much information. The AA data are adapted from those of the L/70, with the hit rolls increased by one for proximity fuzes, one for the BOFI laser rangefinder (effectively FCR-R), and another one for the BOFI-R radar. This gives them hit rolls of 5/5/4 and 6/6/5, whereas \emph{Air Strike} gives the BOFI-R 5/5/4.
}
...
\note{
    For the S-60 battery: The AAA values are from \emph{Air Strike}.
...
\note{
    ...
    The S-60 battery has 2/2/1 and the normal modifier would suggest the ZSU-57-2 have 1/1/0, but in this case a smaller difference is justified as we are comparing four barrels to six.
}
...
\note{
    For the KS-12 battery: The AAA values are from \emph{The Speed of Heat}.
}
...
\note{
    For the KS-12 battery: The AAA values are from \emph{Air Strike}.
}
