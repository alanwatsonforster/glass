...
When this advanced rule is used, the scenario must specify (or the players must agree) whether truck and mobile units have good or poor mobility, according to the terrain and the capabilities of the trucks represented, and explicitly or implicitly assign transport units to towed units.
...
Trucks and tracked carriers are unarmored or incompletely armored vehicles that transport infantry, towed weapons, and supplies. A truck has good/poor mobility, whereas a tracker carrier (e.g., an M548) has unrestricted mobility. Trucks include light trucks such as Jeeps, Land Rovers, and Humvees.
