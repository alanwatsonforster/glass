...
Ground units have a mobility class that can place limits on where they may normally be placed or move on the map. Ground units can have unrestricted (U), good (G), or poor (P) mobility:
\begin{itemize}
...
Infantry units and towed units may be associated with a transport unit.

For the purpose of initial placement, they may be considered to have either their mobility class or that of their transport.

Furthermore, they may be mounted or dismounted. Mounted units have no direct role in sighting or combat, but if their associated transport unit suffers damage, then they suffer the same damage. Mounted units do not count for stacking. For the purpose of movement, mounted units have the same mobility class as their transport. Dismounted units are treated normally.

\subsection{Composite Infantry Platoons}

During initial placement, an infantry platoon or infantry HQ platoon may \emph{attach} one or two infantry squads or one infantry section to form a composite platoon. The attached units are commonly infantry SAM or FAC units. Once formed, composite platoons may not be split into their constituent units.

Composite platoons are considered to have the mobility class of least mobile of their constituent units. Their defense strength is unchanged.

Attached units are not represented by a separate counter, do not count for stacking, and may not be attacked directly, but instead are considered to form part of the composite platoon.
Attached units retain their normal capabilities (i.e., an attached SAM unit may engage aircraft and an attached FAC unit may sight and mark targets).
...
As usual, attached units that suffer damage equal to their damage resilience are killed.
