...
\begin{itemize}
    \item An infantry unit has unrestricted mobility;
    \item An AFV unit, both tracked and wheeled, or a tracked carrier unit has good mobility; and
    \item A truck unit or a towed unit has poor mobility.
\end{itemize}
...
A scenario may remove some of these restrictions or add others. For example, a scenario with airmobile forces might allow a towed artillery battery to have been transported by helicopter to a clear hex far from a road, trail, runway, or urban hex, and another set in the open desert of southern Iraq might allow a truck platoon freedom to occupy any clear hex.
...
Implicitly, an infantry unit has unrestricted mobility, an armored unit has good mobility, and a towed unit has poor mobility. A truck unit has poor mobility if it has a two-wheeled symbol in the lower position and good mobility if it has a three-wheeled, half-tracked, or tracked symbol in the lower position.
...
A composite platoon has the same damage resilience, defense strength, target class, mobility, and sighting range of its constituent platoon.
...
If a composite platoon is killed, each attached unit is killed too. VPs are awarded for damage to any of the constituent units.
