...
\footnote{
    Comparing similar weapons, batteries typically have a \minus{1} advantage on their hit rolls compared to sections.
    In a few cases, the difference is 0 and in others it is \minus{2}.
