...
AAA units are specialized in the use of guns to destroy attacking aircraft. Figure~\ref{figure:aaa-units} shows the representation of AAA units as counters, and Table~\ref{table:aaa-units} summarizes their properties.
...
\footnote{
    Comparing similar weapons in Air Strike, EOTG, and TSOH, batteries typically have a \plus{1} advantage on their hit rolls compared to sections.
