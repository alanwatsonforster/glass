...
At the start of a game, an infantry, infantry weapons, or infantry HQ platoon may \emph{attach} one or two infantry squads or one infantry section to form a \emph{composite platoon}. The attached units are commonly infantry SAM or FAC units. Once formed, a composite platoon may not be split into its constituent units.
...
No VP values are given for transport or fighter airplanes or helicopters, since these can vary significantly with the capacity of the aircraft. The VPs will be specified in by the scenario. As a guideline, they will often be similar to the VP values of the attacking aircraft.

\subsubsection{Bridges}

Unless otherwise indicated in the scenario, a major bridge is one that extends over two or more hexes, a minor bridge is one that is confined to a single hex, and a small bridge is where a road crosses a river without a bridge being marked on the map.
...
This appendix contains a number of example orders of battle:

\begin{itemize}
    \item Table~\ref{table:ob-two-para}: 2 Para Battalion at the 1982 Battle of Goose Green. At this time, the battalion had attached half a battery of 105 mm Light Guns from Alma Battery of 29 Commando Regiment, RA, a section of Blowpipes from 43rd Air Defence Battery, RA, and a Recce Trrop of 59 Independent Commando Squadron, RE.
\end{itemize}
...
\begin{table*}
    ...
    \begin{tabular}{lll}
        ...
        \midrule
        Battalion HQ        &\binarymultiply{1}{infantry HQ platoon}\\
        A Company           &\binarymultiply{3}{infantry platoon}\\
        B Company           &\binarymultiply{3}{infantry platoon}\\
        C Company           &\binarymultiply{2}{infantry platoon} & Patrols Company\\
        D Company           &\binarymultiply{3}{infantry platoon}\\
        Support Company     &\binarymultiply{1}{infantry weapons platoon}&Mortar Platoon\\
        &\binarymultiply{1}{infantry weapons platoon}&Machine-gun Platoon\\
        &\binarymultiply{1}{infantry weapons platoon}&Anti-tank Platoon\\
        &\binarymultiply{1}{infantry platoon}&Assault Pioner Platoon\\
        Alma Battery        &\binarymultiply{1}{towed artillery platoon}&Three 105-mm Light Guns\\
        Blowpipe Section    &\binarymultiply{2}{infantry SAM squad -- Blowpipe}\\
        Engineers Troop     &\binarymultiply{1}{infantry platoon}\\
        \bottomrule
    \end{tabular}
\end{table*}
\end{document}
