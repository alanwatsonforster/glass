...
\paragraph{Echelon.} Most units are platoons or batteries although some are sections or teams.
...
Units equipped with AFVs are hard targets, are referred to as being \emph{armored}, and are classified as \emph{heavy}, \emph{medium}, or \emph{light} according to their degree of protection. Infantry, towed units, and units equipped with unprotected or incompletely protected vehicles are soft targets.

\paragraph{Mobility.}

Units may move on foot, may be vehicular, or may be towed. Vehicular units equipped with AFVs are referred to as being \emph{armored}. Those with unprotected or incompletely protected vehicles are referred to as being \emph{motorized}. 

Wheeled, half-tracked, and tracked vehicles are not distinguished. Thus, armored cars are treated as light tanks (e.g., the AMX-10 RC and Panhard EBR), unarmored tracked cargo-carriers are treated as trucks (e.g., the M548), and incompletely protected tracked or wheeled artillery is treated as motorized artillery (e.g., the wheeled CAESAR and the tracked M107).

\paragraph{Mounted and Dismounted Units.}

Infantry units and towed units may be associated with a vehicular transport unit. If so, then they may be mounted or dismounted. Mounted units have no role in sighting or combat and do not count for stacking, however if their associated vehicle unit suffers damage then they suffer the same damage. Dismounted units are treated normally. Infantry mounted in IFVs or APCs are sometimes better protected the dismounted infantry.
