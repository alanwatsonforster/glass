...
The mobility class of a ground unit places limits on where a unit may normally be placed or move on the map. Ground units can have unrestricted, good, or poor mobility:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Any unit may occupy a hex with a road, trail, or runway.
    \item A unit with good mobility may occupy a clear hex.
    \item A unit with good mobility may occupy a forest hex adjacent to an urban hex, adjacent to a clear hex, or adjacent to another forest hex with a road or trail.
    \item A unit with poor mobility may occupy a clear hex adjacent to an urban hex or adjacent to another clear hex with a road, trail, or runway.
\end{itemize}
...
Figure~\ref{figure:mobility} illustrates these limitations. Units with poor mobility may only occupy the hexes marked with green dots. Those with good mobility may only occupy those marked with yellow or green dots. Those with unlimited mobility may only occupy the hexes marked with red, yellow, or green dots.
