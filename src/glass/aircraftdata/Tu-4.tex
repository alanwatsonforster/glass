...
The Tu-4P version was a conversion carried out by the PLAAF to create a night fighter specifically to counter ROCAF intruders. The navigation radar was moved from its normal ventral position to a radome in place of the forward dorsal turret, creating a basic all-round air-search radar, the bomb bay was converted into an air-intercept command post, and the guns were equipped with a basic infrared sight. It entered service in 1960.
