...
A2.move("ST", "N", "ST", speedbrakes=1.0)
A2._assert("A1-2011       N    51", 2.0)
endgameturn()
...
startgameturn()
A1.move("VC", "M", "EZR/H,H,C2,C2,C2")
asserterror("VC disallows all turns.")
startgameturn()
