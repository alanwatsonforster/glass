...
startgameturn()
A1.move("ST", "M", "ST")
A1._assert("A1-1914       N     8", 1.5)
A2.move("ST", "M", "ST")
A2._assert("A1-2114       N     1", 1.5)
A3.move("ST", "M", "ST")
...
startgameturn()
A1.move("ST", "M", "ST")
A1._assert("A1-1914       N     4", 3.0)
A2.move("ST", "M", "ST")
A2._assert("A1-2114       N     0", 1.5)
endgameturn()

startgameturn()
A1.move("LVL", "M", "H,H,H")
A1._assert("A1-1911       N     4", 3.0)
endgameturn()
...
A1.release("BB")
A1.continuemove("ST")
A1._assert("A2-2024       N     8", 1.5, expectedconfiguration="1/2")
endgameturn()
...
A1.release([1, 4])
A1.continuemove("ST")
A1._assert("A2-2024       N     4", 2.5, expectedconfiguration="CL")
endgameturn()
