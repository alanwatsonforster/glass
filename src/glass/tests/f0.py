...
startgameturn()
A1.move("DP", "M", "MDR150")
A1._assert("A1-1913       SSE   5", 3.0)
startgameturn()
A1.move("DP", "M", "MDL150")
A1._assert("A1-1713       SSW   5", 3.0)
startgameturn()
A3.move("DP", "M", "MDR150")
A3._assert("A1-2312       SSE   3", 5.0)
startgameturn()
A1.move("DP", "M", "R150")
A1._assert("A1-1814       SSE   5", 3.0)
A2.move("DP", "M", "L300")
A2._assert("A1-2014       ENE   7", 1.0)
A3.move("DP", "M", "MDL150")
A3._assert("A1-2112       SSW   3", 5.0)
endgameturn()

startgameturn()
A1.move("DP", "M", "R150")
A1._assert("A1-1814       WNW   0", 3.0)
A2.move("DP", "M", "L300")
A2._assert("A1-2014       ESE   2", 1.0)
A3.move("DP", "M", "R180")
