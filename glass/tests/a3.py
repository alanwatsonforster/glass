...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-80C", "A1-1115", 0, 10, 4.0, "CL")
A2 = setupaircraft("A2", "AF", "F-80C", "A1-1315", 90, 10, 4.0, "CL")
A3 = setupaircraft("A3", "AF", "F-80C", "A1-1515", 180, 10, 4.0, "CL")
A4 = setupaircraft("A4", "AF", "F-80C", "A1-1715", 270, 10, 4.0, "CL")
endtestsetup()
...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-80C", "A1-1115", "ENE", 10, 4.0, "CL")
A2 = setupaircraft("A2", "AF", "F-80C", "A1-1315", "ESE", 10, 4.0, "CL")
A3 = setupaircraft("A3", "AF", "F-80C", "A1-1515", "WSW", 10, 4.0, "CL")
A4 = setupaircraft("A4", "AF", "F-80C", "A1-1715", "WNW", 10, 4.0, "CL")
endtestsetup()
...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-80C", "A1-1115", "NE", 10, 4.0, "CL")
A2 = setupaircraft("A2", "AF", "F-80C", "A1-1315", "SE", 10, 4.0, "CL")
A3 = setupaircraft("A3", "AF", "F-80C", "A1-1515", "SW", 10, 4.0, "CL")
A4 = setupaircraft("A4", "AF", "F-80C", "A1-1715", "NW", 10, 4.0, "CL")
endtestsetup()
