...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-100C", "A2-2025", "N", 5, 5.0, "CL")
endtestsetup()
startgameturn()
...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-5A", "A2-2025", "N", 5, 5.0, "CL")
...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-80C", "A2-2025", "N", 5, 5.0, "CL")
assert not A1.hasproperty("HRR")
assert not A1.hasproperty("LRR")
endtestsetup()
...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-104A", "A2-2030", "N", 5, 5.0, "CL")
endtestsetup()
startgameturn()
A1.move("UD", "AB", "HU,HU,HU,HU,HU")
A1._assert("A2-2025       N     3", 6.5)
startgameturn()
...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-104A", "A2-2030", "N", 5, 9.0, "CL")
A2 = setupaircraft("A2", "AF", "F-104A", "A2-2030", "N", 5, 9.0, "CL")
endtestsetup()
...
starttestsetup()
A1 = setupaircraft("A1", "AF", "F-80C", "A2-2025", "N", 5, 5.0, "CL")
A2 = setupaircraft("A2", "AF", "F-80C", "A2-2225", "N", 5, 5.0, "CL")
endtestsetup()
