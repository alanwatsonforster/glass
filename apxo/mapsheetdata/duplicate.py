...
for newsheet, oldsheet in [
    ...
    with open(oldsheet + ".json", "r", encoding="utf-8") as f:
        oldterrain = json.load(f)
    ...
    with open(newsheet + ".json", "w", encoding="utf-8") as f:
        json.dump(newterrain, f, indent=4, sort_keys=False, ensure_ascii=False)
