    ...
    if _allwater:
      ...
      if not _wilderness:
        ...
        if _rivers:
          ...
          for sheet in sheets():
            drawpaths(sheet, _terrain[sheet]["trailpaths"], color=roadoutlinecolor, linewidth=roadwidth+roadoutlinewidth, capstyle="projecting", linestyle=(0,(1,1)))
          for sheet in sheets():
            drawpaths(sheet, _terrain[sheet]["trailpaths"], color=level0color, linewidth=roadwidth, capstyle="projecting")
...
_terrain = {
  ...
  "L": {
    ...
    "trailpaths": [
      ...
      [[60.00,55.00],[60.10,55.00],[63.00,54.00],[64.00,54.00],
       [66.00,53.00],[68.00,54.00],[70.00,53.00],[72.00,54.00]],
