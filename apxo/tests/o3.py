...
G0 = groundunit("G0", "A1-2120", "infantry", aaaclass="B", maximumaltitude=2)
G1 = groundunit("G1", "A1-2120", "infantry", aaaclass="B", maximumaltitude=2)
G2 = groundunit("G2", "A1-2120", "armor", aaaclass="B", maximumaltitude=3)
G3 = groundunit("G3", "A1-2120", "artillery")
G4 = groundunit("G4", "A1-2120", "airdefense/gun", aaaclass="L", maximumaltitude=9)
G5 = groundunit("G5", "A1-2120", "airdefense/gun", aaaclass="M", maximumaltitude=18)
G6 = groundunit("G6", "A1-2120", "airdefense/gun", aaaclass="H", maximumaltitude=27)
