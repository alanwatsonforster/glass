...
assert A1.gunrange(A2) == "the target is not in the weapon range or arc."
A2 = aircraft("B2", "F-80C"  , "2025", "W", 5, 4.0, "CL")
assert A1.gunrange(A2) == 0
...
assert A1.gunrange(A0) == "aircraft in level flight cannot fire at range 0 on aircraft at a different altitude."
assert A2.gunrange(A0) == "the target is not in the weapon range or arc."
assert A3.gunrange(A0) == "aircraft in climbing flight cannot fire on aircraft at lower altitudes."

A0 = aircraft("B0", "F-80C"  , "2025", "N",  5, 4.0, "CL")
assert A1.gunrange(A0) == "aircraft in level flight cannot fire at range 0 on aircraft at a different altitude."
assert A2.gunrange(A0) == 2
assert A3.gunrange(A0) == "aircraft in climbing flight cannot fire on aircraft at lower altitudes."
...
assert A1.gunrange(A0) == "aircraft in level flight cannot fire at range 0 on aircraft at a different altitude."
assert A2.gunrange(A0) == 0
assert A3.gunrange(A0) == "aircraft in climbing flight cannot fire on aircraft at lower altitudes."

A0 = aircraft("G0", "F-80C"  , "2025", "N", 10, 4.0, "CL")
assert A1.gunrange(A0) == 0
assert A2.gunrange(A0) == 0
assert A3.gunrange(A0) == 0

A0 = aircraft("H0", "F-80C"  , "2025", "N", 11, 4.0, "CL")
assert A1.gunrange(A0) == "aircraft in level flight cannot fire at range 0 on aircraft at a different altitude."
assert A2.gunrange(A0) == "aircraft in diving flight cannot fire on aircraft at higher altitudes."
assert A3.gunrange(A0) == 0

A0 = aircraft("I0", "F-80C"  , "2025", "N", 12, 4.0, "CL")
assert A1.gunrange(A0) == "aircraft in level flight cannot fire at range 0 on aircraft at a different altitude."
assert A2.gunrange(A0) == "aircraft in diving flight cannot fire on aircraft at higher altitudes."
assert A3.gunrange(A0) == 1
...
assert A1.gunrange(A0) == "aircraft in level flight cannot fire at range 0 on aircraft at a different altitude."
assert A2.gunrange(A0) == "aircraft in diving flight cannot fire on aircraft at higher altitudes."
assert A3.gunrange(A0) == "the target is not in the weapon range or arc."

# Horizontal range 1

A0 = aircraft("N0", "F-80C"  , "2024", "N",  4, 4.0, "CL")
assert A1.gunrange(A0) == "aircraft in level flight cannot fire on aircraft with more than 1 level of difference in altitude."
assert A2.gunrange(A0) == "the target is not in the weapon range or arc."
assert A3.gunrange(A0) == "aircraft in climbing flight cannot fire on aircraft at lower altitudes."
