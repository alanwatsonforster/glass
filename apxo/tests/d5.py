...
starttestsetup()
A1 = aircraft("A1", "AF", "F-111A", "A1-2010", "N", 5, 3.5, "CL", geometry="forward")
A2 = aircraft("A2", "AF", "F-111A", "A1-2210", "N", 5, 3.5, "CL", geometry="mid")
A3 = aircraft("A3", "AF", "F-111A", "A1-2410", "N", 5, 3.5, "CL", geometry="aft")
endtestsetup()
...
starttestsetup()
A1 = aircraft("A1", "AF", "F-111A", "A1-2010", "N", 5, 2.0, "CL", geometry="forward")
A2 = aircraft("A2", "AF", "F-111A", "A1-2210", "N", 5, 2.0, "CL", geometry="mid")
A3 = aircraft("A3", "AF", "F-111A", "A1-2410", "N", 5, 2.0, "CL", geometry="aft")
endtestsetup()
startgameturn()
