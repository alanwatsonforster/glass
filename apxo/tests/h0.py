...
A1._assert("2024       N    10", 4.0, expectedconfiguration="DT")
endtestsetup()
...
A1._assert("2024       N    10", 4.0, expectedconfiguration="1/2")
endtestsetup()
...
A1._assert("2024       N    10", 4.0, expectedconfiguration="CL")
endtestsetup()
...
A1._assert("2020       N    10", 4.5, expectedconfiguration="CL")
endturn()
...
A1._assert("2020       N    10", 4.0, expectedconfiguration="1/2")
endturn()

startturn()
A1.move("LVL", "N", "H/J(1+4),H,H,H")
A1._assert("2016       N    10", 4.0, expectedconfiguration="CL")
endturn()
