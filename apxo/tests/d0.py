...
A2.move("LVL", "M", "TTL/H,HL,H,H/WL")
A2._assert("A1-1911       NNW  10", 4.0)
A3.move("LVL", "M", "TTR/H,HR,H,H/WL")
...
startgameturn()
A1.move("LVL", "M", "H/WL,TTR/H,HR,TTR/H")
...
A4.move("LVL", "M", "H/WL,TTL/H,HL,TTL/H")
...
startgameturn()
A1.move("LVL", "M", "TTL/H,HL,H/WL,HTR/HR")
A1._assert("A1-1812       N    12", 4.0)
A2.move("LVL", "M", "TTR/H,HR,H/WL,HTL/HL")
