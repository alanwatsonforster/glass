...
G4 = groundunit(
    "G4", "A1-2110", symbols="airdefense/gun", aaaclass="L", maximumaltitude=9
)
G5 = groundunit(
    "G5", "A1-2110", symbols="airdefense/gun", aaaclass="M", maximumaltitude=18
)
G6 = groundunit(
    "G6", "A1-2110", symbols="airdefense/gun", aaaclass="H", maximumaltitude=27
)
