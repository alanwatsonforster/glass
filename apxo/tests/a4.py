...
assert 1 == distance(*toxy("A2-2329"), *toxy("A2-2328/2229"))
assert 1 == distance(*toxy("A2-2329"), *toxy("A2-2328/2429"))
...
assert 2 == distance(*toxy("A2-2329"), *toxy("A2-2327/2228"))
assert 2 == distance(*toxy("A2-2329"), *toxy("A2-2327/2428"))
...
assert 3 == distance(*toxy("A2-2329"), *toxy("A2-2326/2227"))
assert 3 == distance(*toxy("A2-2329"), *toxy("A2-2326/2427"))
...
assert 1 == distance(*toxy("A2-2329/2330"), *toxy("A2-2329/2229"))
assert 1 == distance(*toxy("A2-2329/2330"), *toxy("A2-2329/2429"))
...
assert 2 == distance(*toxy("A2-2329/2330"), *toxy("A2-2328/2228"))
assert 2 == distance(*toxy("A2-2329/2330"), *toxy("A2-2328/2428"))
...
assert 3 == distance(*toxy("A2-2329/2330"), *toxy("A2-2327/2227"))
assert 3 == distance(*toxy("A2-2329/2330"), *toxy("A2-2327/2427"))
...
assert 1 == distance(*toxy("A2-2329/2230"), *toxy("A2-2229"))
assert 1 == distance(*toxy("A2-2329/2230"), *toxy("A2-2328/2329"))
...
assert 2 == distance(*toxy("A2-2329/2230"), *toxy("A2-2228"))
assert 2 == distance(*toxy("A2-2329/2230"), *toxy("A2-2327/2328"))
...
assert 3 == distance(*toxy("A2-2329/2230"), *toxy("A2-2227"))
assert 3 == distance(*toxy("A2-2329/2230"), *toxy("A2-2326/2327"))
