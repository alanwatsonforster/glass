...
endtestsetup()
startgameturn()
A1.move("SD", "AB", "H,DRL/D,D,HL,H,H,H")
A1._assert("A1-1611 N 8", 8.0)
startgameturn()
A1.move("SD", "AB", "H,DRL/H,D,HL,H,H,D")
A1._assert("A1-1611 N 8", 8.0)
startgameturn()
A1.move("SD", "AB", "H,DRL/H,H,HL,D,D,D")
A1._assert("A1-1612       N     7", 8.0)
startgameturn()
A1.move("ZC", "AB", "H,DRL/C,H,HL,H,H,C")
A1._assert("A1-1611 N 12", 7.0)
startgameturn()
A1.move("ZC", "AB", "H,DRL/C,C,HL,H,H,H")
A1._assert("A1-1611 N 12", 7.0)
startgameturn()
A1.move("ZC", "AB", "H,DRL/H,H,HL,H,C,C")
A1._assert("A1-1611 N 12", 7.0)
endgameturn()

startgameturn()
A1.move("ZC", "AB", "H,DRL/C,H,HL,H,C")
