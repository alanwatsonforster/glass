...
starttestsetup()
A1 = aircraft("A1", "AF", "F-80C", "1415", "N", 20, 4.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "1615", "N", 20, 4.0, "CL")
endtestsetup()
...
starttestsetup(verbose=False)
A1 = aircraft("A1", "AF", "F-80C", "1715", "N", 20, 4.0, "CL")
...
starttestsetup(verbose=False)
A1 = aircraft("A1", "AF", "F-104A", "1215", "N", 20, 7.5, "CL") # GSSM
A2 = aircraft("A2", "AF", "F-100A", "1415", "N", 20, 7.5, "CL")
A3 = aircraft("A3", "AF", "F-102A", "1615", "N", 20, 7.5, "CL") # PSSM
endtestsetup()
