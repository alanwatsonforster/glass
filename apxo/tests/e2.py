...
asserterror("attempt to dive 1 level per VFP while the flight type is VD.")
startgameturn()
A1.move("VD", "M", "EZR/H,H,D3,D3,D3")
asserterror("attempt to declare turn while flight type is VD.")
startgameturn()
