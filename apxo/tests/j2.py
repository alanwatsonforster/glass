...
assert A1._rocketattackrange(A2) == "the target is not in the weapon range or arc."
...
assert A1._rocketattackrange(A0) == "the target is not in the weapon range or arc."
assert A2._rocketattackrange(A0) == "the target is not in the weapon range or arc."
assert A3._rocketattackrange(A0) == "the target is not in the weapon range or arc."
