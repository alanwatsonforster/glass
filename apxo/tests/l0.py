...
starttestsetup()
A1 = aircraft("A1", "AF", "F-104A"  , "2025", "N", 5, 5.0, "CL", fuel=100)
endtestsetup()
...
starttestsetup()
A1 = aircraft("A1", "AF", "Meteor F.8"  , "2025", "N", 5, 5.0, "CL", fuel=100)
endtestsetup()
...
starttestsetup()
A1 = aircraft("A1", "AF", "F-80C"  , "2025", "N", 5, 5.0, "CL", fuel="100%")
endtestsetup()
assert A1._fuel == 135

starttestsetup()
A1 = aircraft("A1", "AF", "F-80C"  , "2025", "N", 5, 5.0, "CL", fuel="50%")
endtestsetup()
