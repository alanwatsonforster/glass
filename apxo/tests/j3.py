...
assert A1._gunattackrange(A2, arc="90-") == "the target is not in the weapon range or arc."
...
assert A1._gunattackrange(A0, arc="90-") == "the target is not in the weapon range or arc."
assert A2._gunattackrange(A0, arc="90-") == "the target is not in the weapon range or arc."
assert A3._gunattackrange(A0, arc="90-") == "the target is not in the weapon range or arc."
