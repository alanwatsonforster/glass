...
startturn()
A1.move("LVL",  "AB", "H,H,H,H,H,H,H,H,H")
A1._assert("4010       S    30",  8.5)
A2.move("LVL",  "M", "H,H,H,H,H,H,H,H")
A2._assert("4209       S    30",  7.5)
A3.move("LVL",  "N", "H,H,H,H,H,H,H")
A3._assert("4408       S    30",  6.0)
A4.move("LVL",  "I", "H,H,H,H,H,H")
A4._assert("4606       S    30",  5.5)
endturn()

startturn()
A1.move("LVL",  "AB", "H,H,H,H,H,H,H,H")
A1._assert("4018       S    30",  8.5)
A2.move("LVL",  "M", "H,H,H,H,H,H,H")
A2._assert("4216       S    30",  7.5)
A3.move("LVL",  "N", "H,H,H,H,H,H")
A3._assert("4414       S    30",  5.5)
A4.move("LVL",  "I", "H,H,H,H,H")
A4._assert("4611       S    30",  5.0)
endturn()
...
startturn()
A4.move("VD",  "AB", "H,H,D3,D3,D3,D3")
A4._assert("2608       S    38",  9.0)
endturn()

startturn()
A4.move("SD",  "AB", "H,H,H,H,D2,D2,D2,D2,D2")
A4._assert("2612       S    28",  10.5)
endturn()

startturn()
A4.move("LVL",  "AB", "H,H,H,H,H,H,H,H,H,H")
A4._assert("2622       S    28",  9.5)
endturn()

startturn()
A4.move("LVL",  "I", "H,H,H,H,H,H,H,H,H,H")
A4._assert("4602       S    28",  6.5)
endturn()

startturn()
A4.move("LVL",  "I", "H,H,H,H,H,H")
A4._assert("4608       S    28",  6.0)
endturn()

startturn()
A4.move("LVL",  "I", "H,H,H,H,H,H")
A4._assert("4614       S    28",  5.0)
endturn()
