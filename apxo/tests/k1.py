...
starttestsetup()
A1 = aircraft("A1", "AF", "F-100C"  , "2025", "N", 5, 5.0, "CL")
endtestsetup()
startturn()
...
starttestsetup()
A1 = aircraft("A1", "AF", "F7U-3"  , "2025", "N", 5, 5.0, "CL")
...
starttestsetup()
A1 = aircraft("A1", "AF", "F-5A"  , "2025", "N", 5, 5.0, "CL")
...
starttestsetup()
A1 = aircraft("A1", "AF", "F-80C"  , "2025", "N", 5, 5.0, "CL")
assert not A1.hasproperty("HRR")
assert not A1.hasproperty("LRR")
endtestsetup()
...
starttestsetup()
A1 = aircraft("A1", "AF", "F-104A"  , "2030", "N", 5, 5.0, "CL")
endtestsetup()
startturn()
...
starttestsetup()
A1 = aircraft("A1", "AF", "F-104A", "2030", "N", 5, 9.0, "CL")
A2 = aircraft("A2", "AF", "F-104A", "2030", "N", 5, 9.0, "CL")
endtestsetup()
