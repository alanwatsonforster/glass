...
A1 = aircraft("A1", "AF", "MiG-17F"  , "A1-2015", "N", 6, 4.0)
A2 = aircraft("A2", "AF", "F-86A"    , "A1-2215", "N", 9, 4.0)
A3 = aircraft("A3", "AF", "F-84E"    , "A1-2013", "N", 5, 3.5)
A4 = aircraft("A4", "AF", "F-84E"    , "A1-2012", "NNE", 6, 3.5)
A5 = aircraft("A5", "AF", "F-84E"    , "A1-2012", "NNE", 5, 3.5)
A6 = aircraft("A6", "AF", "F-84E"    , "A1-2012", "NNE", 6, 3.5)
A7 = aircraft("A7", "AF", "F-84E"    , "A1-2012", "NNE", 7, 3.5)
A8 = aircraft("A8", "AF", "F-84E"    , "B1-4012", "NNE", 7, 3.5)
...
assert A3._visualsightingcondition(A1) == ("within visual range but blind (30- arc)", False, False, False)
assert A4._visualsightingrange    (A1) == 3
assert A4._visualsightingcondition(A1) == ("within visual range but blind (30- arc)", False, False, False)
assert A5._visualsightingrange    (A1) == 3
assert A5._visualsightingcondition(A1) == ("within visual range but blind (30- arc)", False, False, False)
assert A6._visualsightingrange    (A1) == 3
assert A6._visualsightingcondition(A1) == ("within visual range but blind (30- arc)", False, False, False)
assert A7._visualsightingrange    (A1) == 3
assert A7._visualsightingcondition(A1) == ("within visual range but blind (30- arc)", False, False, False)
...
assert A3._visualsightingcondition(A2) == ("within visual range but restricted (60- arc)", True, True, True)
...
assert A8._visualsightingcondition(A2) == ("within visual range but restricted (60- arc)", True, True, True)
...
assert A1._visualsightingcondition(A3) == ("within visual range but restricted (180L arc)", True, True, True)
...
assert A4._visualsightingcondition(A3) == ("within visual range but blind (30- arc)", False, False, False)
assert A5._visualsightingrange    (A3) == 1
assert A5._visualsightingcondition(A3) == ("within visual range but blind (30- arc)", False, False, False)
assert A6._visualsightingrange    (A3) == 1
assert A6._visualsightingcondition(A3) == ("within visual range but blind (30- arc)", False, False, False)
assert A7._visualsightingrange    (A3) == 2
assert A7._visualsightingcondition(A3) == ("within visual range but blind (30- arc)", False, False, False)
...
assert A5._visualsightingcondition(A4) == ("within visual range (immediately above)", True, True, False)
assert A6._visualsightingrange    (A4) == 0
assert A6._visualsightingcondition(A4) == ("within visual range but blind (30- arc)", False, False, False)
assert A7._visualsightingrange    (A4) == 0
assert A7._visualsightingcondition(A4) == ("within visual range and can padlock, but blind (immediately below)", False, True, False)
assert A8._visualsightingrange    (A4) == 20
assert A8._visualsightingcondition(A4) == ("within visual range but restricted (60- arc)", True, True, True)
...
assert A1._visualsightingcondition(A5) == ("within visual range but restricted (180L arc)", True, True, True)
...
assert A4._visualsightingcondition(A5) == ("within visual range and can padlock, but blind (immediately below)", False, True, False)
assert A6._visualsightingrange    (A5) == 0
assert A6._visualsightingcondition(A5) == ("within visual range and can padlock, but blind (immediately below)", False, True, False)
assert A7._visualsightingrange    (A5) == 1
assert A7._visualsightingcondition(A5) == ("within visual range and can padlock, but blind (immediately below)", False, True, False)
...
assert A4._visualsightingcondition(A6) == ("within visual range but blind (30- arc)", False, False, False)
assert A5._visualsightingrange    (A6) == 0
assert A5._visualsightingcondition(A6) == ("within visual range (immediately above)", True, True, False)
assert A7._visualsightingrange    (A6) == 0
assert A7._visualsightingcondition(A6) == ("within visual range and can padlock, but blind (immediately below)", False, True, False)
assert A8._visualsightingrange    (A6) == 20
assert A8._visualsightingcondition(A6) == ("within visual range but restricted (60- arc)", True, True, True)
...
assert A4._visualsightingcondition(A7) == ("within visual range (immediately above)", True, True, False)
assert A5._visualsightingrange    (A7) == 0
assert A5._visualsightingcondition(A7) == ("within visual range (immediately above)", True, True, False)
assert A6._visualsightingrange    (A7) == 0
assert A6._visualsightingcondition(A7) == ("within visual range (immediately above)", True, True, False)
assert A8._visualsightingrange    (A7) == 20
assert A8._visualsightingcondition(A7) == ("within visual range but restricted (60- arc)", True, True, True)
...
assert A9._visualsightingcondition(A8) == ("within visual range but blind (30- arc)", False, False, False)
...
assert A8._visualsightingcondition(A9) == ("within visual range but blind (30- arc)", False, False, False)
