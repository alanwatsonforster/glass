...
A1._assert("1115           N    10", 4.0, expectedconfiguration="CL")
A2._assert("1315       NNE  20", 4.5, expectedconfiguration="CL")
A3._assert("1515       ENE  30", 5.0, expectedconfiguration="1/2")
A4._assert("1715       NNW  40", 5.5, expectedconfiguration="CL")
A5._assert("1915       WNW  50", 6.0, expectedconfiguration="DT")
