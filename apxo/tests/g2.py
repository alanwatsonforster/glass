...
A1 = aircraft("A1", "AF", "F-80C", "1708", "E", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "E", 10, 2.0, "CL")
endtestsetup()
startturn()
...
A1 = aircraft("A1", "AF", "F-80C", "1708", "ENE", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "ENE", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "NNE", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "NNE", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "N", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "N", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "NNW", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "NNW", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "WNW", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "WNW", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "W", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "W", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "WSW", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "WSW", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "SSW", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "SSW", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "S", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "S", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "SSE", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "SSE", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
...
starttestsetup(sheets=[["A1"]])
A1 = aircraft("A1", "AF", "F-80C", "1708", "ESE", 10, 2.0, "CL")
A2 = aircraft("A2", "AF", "F-80C", "2308", "ESE", 10, 2.0, "CL")
endtestsetup()
startturn()
A1.move("LVL",  "M", "LRL/H,HL")
