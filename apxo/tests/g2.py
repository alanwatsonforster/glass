...
endtestsetup()
startgameturn()
A1.move("LVL", "AB", "H,LRL/H,H,H,H,HL,H,H,H,H,H,H")
asserterror("attempt to roll without sufficient preparatory FPs.")
startgameturn()
A1.move("LVL", "AB", "H,LRL/H,H,H,H,H,HL,H,H,H,H,H")
A1._assert("A1-1605/1705 NNE 20", 12.0)
startgameturn()
A2.move("LVL", "AB", "H,LRL/H,H,H,H,H,HL,H,H,H,H,H")
asserterror("attempt to roll without sufficient preparatory FPs.")
startgameturn()
A2.move("LVL", "AB", "H,LRL/H,H,H,H,H,H,HL,H,H,H,H")
A2._assert("A1-1805 NNE 30", 12.0)
startgameturn()
A3.move("LVL", "AB", "H,LRL/H,H,H,H,H,H,HL,H,H,H,H")
asserterror("attempt to roll without sufficient preparatory FPs.")
startgameturn()
A3.move("LVL", "AB", "H,LRL/H,H,H,H,H,H,H,HL,H,H,H")
A3._assert("A1-1904/2005 NNE 40", 12.0)
startgameturn()
A4.move("LVL", "AB", "H,LRL/H,H,H,H,H,H,H,HL,H,H,H")
asserterror("attempt to roll without sufficient preparatory FPs.")
startgameturn()
A4.move("LVL", "AB", "H,LRL/H,H,H,H,H,H,H,H,HL,H,H")
A4._assert("A1-2104 NNE 50", 12.0)
startgameturn()
A5.move("LVL", "AB", "H,LRL/H,H,H,H,H,H,H,H,HL,H,H")
asserterror("attempt to roll without sufficient preparatory FPs.")
startgameturn()
A5.move("LVL", "AB", "H,LRL/H,H,H,H,H,H,H,H,H,HL,H")
...
A1._assert("A1-1109/1209 NNW 20", 7.5)
