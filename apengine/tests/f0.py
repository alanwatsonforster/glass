...
startturn()
A1.move("SD" ,  "M", "BTR/HRRR,HRRR,HRRR"    )
A1._assert("2110       W    10",  1.5)
endturn()
...
A2.move("SD",  "M", "H,H,H,H,H,H"          )
A2._assert("2224       N    59",  6.0)
