...
A2._assert("2209       N    40",  4.0)
A3.move("ZC" ,  "N", "H,H,H,H,H")
A3._assert("2408       N    10",  5.0)
endturn()
...
startturn()
A1.move("SD" ,  "N", "H,H,H,H"  )
A1._assert("2010       NNW  40",  4.0)
endturn()

startturn()
A1.move("VD" ,  "M", "H,D2,D2,D2/VRR/R30"  )
A1._assert("2009       N    34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRR/R60"  )
A1._assert("2009       NNE  34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRR/R90"  )
A1._assert("2009       ENE  34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRR/R120" )
A1._assert("2009       E    34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRR/R150" )
A1._assert("2009       ESE  34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRR/RS180")
A1._assert("2009       SSE  34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRR/R180" )
A1._assert("1909/2009  SSE  34",  5.5)

A1.move("VD" ,  "M", "H,D2,D2,D2/VRL/L30"  )
A1._assert("1909       WNW  34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRL/L60"  )
A1._assert("1909       W    34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRL/L90"  )
A1._assert("1909       WSW  34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRL/L120" )
A1._assert("1909       SSW  34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRL/L150" )
A1._assert("1909       S    34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRL/LS180")
A1._assert("1909       SSE  34",  5.5)
A1.move("VD" ,  "M", "H,D2,D2,D2/VRL/L180" )
A1._assert("1909/2009  SSE  34",  5.5)
endturn()
...
startsetup()
A1 = aircraft("A1", "F-80C", 2019, "N", 40, 4.0, "CL")
endsetup()
...
startsetup()
A1 = aircraft("A1", "Meteor F.8", 2019, "N", 40, 4.0, "CL")
endsetup()
...
startsetup(verbose=False)
A1 = aircraft("A1", "F-100A", 2030, "N", 1, 8.0, "CL")
endsetup()

startturn()
A1.move("SC",  "AB", "H,H,H,H,H,H,H,H")
A1._assert("2022       N     1",  7.5)
endturn()

startturn()
A1.move("VC",  "AB", "H,H,C2,C2,C2,C2,C2"                        )
A1._assert("2020       N    11",  3.5)
A1.move("VC",  "AB", "H,H,C2/VRR/R,C2/VRL/L,C2/VRR/R,C2/VRL/L,C2/VRR/R")
A1._assert("2020       NNE  11",  1.0)
endturn()
