...
A1._assert("2012       N    21",  4.0)
A2.move("SC",  "M", "H,H,H,C")
A2._assert("2212       N    20",  4.0)
A3.move("ZC",  "M", "H,H,H,H,C")
A3._assert("2411       N    21",  5.0)
A4.move("SC",  "M", "H,H,H,H,C")
A4._assert("2611       N    20",  5.0)
...
A1._assert("2008       N     9",  6.5)
A2.move("SD",  "N", "H,H,H,D,D,D")
A2._assert("2208       N     8",  6.5)
A3.move("SD/HRD",  "M", "H,H,D,D")
A3._assert("2407       N    22",  4.0)
A4.move("SD/HRD",  "M", "H,H,D,D")
A4._assert("2607       N    21",  4.5)
